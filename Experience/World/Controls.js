            ...
            all: ()=> {
                ...
                this.room.children.forEach((child)=>{
                    if(child.name === "Mini_Floor002"){
                        this.first2 = GSAP.to(child.scale, {
                            x: 1,
                            y: 1,
                            z: 1,
                        });
                    if(child.name === "Mini_Floor002"){
                        this.first = GSAP.to(child.position, {
                            x: -3.8347344398498535,
                            y: 0.22905993461608887,
                            z: 13.177870750427246,
                            duration: 1
                        });
                    }
                }                          
                    if(child.name === "Mailbox002"){
                ...
                this.secondPartTimeline.add(this.first2);
